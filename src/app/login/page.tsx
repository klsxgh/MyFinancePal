...
export default function LoginPage() {
  const { signInWithEmail, signInWithGoogle, signInAsGuest, loading, error, setError } = useAuth();
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Button type="submit" className="w-full" disabled={loading || isGoogleLoading}>
                {loading && !isGoogleLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <LogIn className="mr-2 h-4 w-4" />}
                Sign In
              </Button>
            </form>
          </Form>
